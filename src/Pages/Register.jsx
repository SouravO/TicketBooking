...
const Register = () => {
  ...
  return (
    <>
      <div className=" w-full " style={{ backgroundImage: `url(${regBg})` }}>
        <div className="mt-10 w-full">
          ...
          <div className="flex flex-col items-center justify-center min-h-screen bg-cover bg-center px-2 md:px-0">
